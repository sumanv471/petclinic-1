                                    ...
                                    sshPublisher(
                                            ...
                                            publishers:  [
                                                sshPublisherDesc(
                                                    ...
                                                    transfers:[   
                                                        sshTransfer(
								execCommand:"docker stop $${docker ps - a - q} && docker rm $${docker ps -a -q} && docker system prune -a --force && cd docker && docker build -t petclinic . --no-cache && docker run -itd --name petclinic8 -p 8080:8080 petclinic"
                                                        )
                                                    ]
                                                )
                                            ]  
