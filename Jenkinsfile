                                    ...
                                    sshPublisher(
                                            ...
                                            publishers:  [
                                                sshPublisherDesc(
                                                    ...
                                                    transfers:[   
                                                        sshTransfer(
								execCommand:""docker stop $(docker ps -aq)" && "docker rm $(docker ps -aq)" && docker system prune -a --force && cd docker && docker build -t petclinic . --no-cache && docker run -itd --name petclinic8 -p 8080:8080 petclinic"
                                                        )
                                                    ]
                                                )
                                            ]  
